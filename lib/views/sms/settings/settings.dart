...
class _SettingsState extends State<Settings> {
  ...
  saveParentContacts(BuildContext context) async {
    ...
    String url = 'http://192.168.42.224:8000/backend/operations/readAll.php';
  ...
  saveTeacherContacts(BuildContext context) async {
    final SmsManager smsManager = new SmsManager();
    String url = 'http://192.168.42.224:8000/backend/operations/readAllTeachers.php';
    final response = await client.get(url);
    final Map result = json.decode(response.body);
    if (response.statusCode == 200) {
  ...
  saveClasses(BuildContext context) async {
    final SmsManager smsManager = new SmsManager();
    String url = 'http://192.168.42.224:8000/backend/operations/readClass.php';
  ...
  saveStreams(BuildContext context) async {
    final SmsManager smsManager = new SmsManager();
    String url = 'http://192.168.42.224:8000/backend/operations/readStream.php';
  ...
  saveSubOrdinate(BuildContext context) async {
    final SmsManager smsManager = new SmsManager();
    String url = 'http://192.168.42.224:8000/backend/operations/readAllSubOrdinate.php';
